...
function Right() {
    ...
    return ( 
        ...
        <h1 className='text-white' style={{"fontSize":"25px"}} > Tsukasag</h1>
            ...
            <section className="d-flex my-0">
                <span className="m-2 fs-7">New Booking</span>
                ...
                <button class="w3-button" style={{"width":"100px","height":"35px","marginTop":"19px","borderRadius":"10px","marginLeft":"120px","backgroundColor":"red"}}>Cancel</button>
            </section>
            ...
            <h3  style={{"textDecoration":"underline","lineHeight":"10px","fontSize":"18px","marginLeft":"20px","marginRight":"5rem","textUnderlinePosition":"under","marginLeft":"14px"}}>Bill Total</h3>
  ...
  <tr style={{"border":"2px solid white"}}>
    ...
    <th style={{"backgroundColor":"grey","color":"white","padding":"10px","textAlign":"right"}} > <span style={{"fontSize":"13px","padding":"12px","fontWeight":"600"}}> Total</span></th>
  </tr>
  <tr>
    ...
    <td style={{"textAlign":"right","padding":"10px 20px"}} >&#8377; <span> 25000.00</span></td>
  ...
  <tr>
    ...
    <td style={{"textAlign":"left","padding":"10px 20px"}} >1</td>
    <td style={{"textAlign":"right","padding":"10px 20px"}} >&#8377; <span> 1000.00</span></td>
  </tr>
  <tr>
...
<table style={{"borderCollapse":"collapse","width":"20%","marginRight":"22px","marginTop":"25px","textAlign":"center","padding":"10px","float":"right"}} >
  ...
  <th>&#8377;{""}9,000.00</th>
            ...
            <section class="d-flex justify-content-center m-3">
                <button class="btn btn-danger ps-2 mx-2">
                <img src={left} alt="" className="w-25 ms-1 mx-2"/>
                    Back
                </button>
                <button class="btn btn-success ps-5 mx-2" style={{"textAlign":"center"}}>Save
